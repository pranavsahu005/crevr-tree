#!/usr/bin/env python3
"""Generate the main generator logic"""
import os
...
print(f"Generator part length: {len(gen)}")

with open(os.path.join(d, 'generator_logic.py'), 'w', encoding='utf-8') as f:
    f.write(gen)
print("Generator logic written")
